                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
                            <div>
                                <div class="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        <h3 class="text-xl font-bold text-dark-800">yuanhang</h3>
                                        <p class="text-gray-600 text-sm">3530848467@qq.com</p>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-3">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <a href="https://github.com/6TangYuan/what-to-eat" target="_blank" class="block text-blue-600 hover:text-blue-700 underline text-sm">
                                                github.com/6TangYuan/what-to-eat
                                            </a>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3">
