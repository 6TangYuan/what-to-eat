...
[![GitHub](https://img.shields.io/badge/GitHub-6TangYuan/what--to--eat-black?style=for-the-badge&logo=github)](https://github.com/6TangYuan/what-to-eat)
[![Config System](https://img.shields.io/badge/⚙️_Dynamic_Config-Real--time_AI_Settings-blue?style=for-the-badge)](https://github.com/6TangYuan/what-to-eat#%EF%B8%8F-动态配置系统)
...
```bash
# 克隆项目
git clone https://github.com/6TangYuan/what-to-eat.git
cd what-to-eat
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/6TangYuan/what-to-eat&env=VITE_TEXT_GENERATION_BASE_URL,VITE_TEXT_GENERATION_API_KEY,VITE_TEXT_GENERATION_MODEL,VITE_IMAGE_GENERATION_BASE_URL,VITE_IMAGE_GENERATION_API_KEY,VITE_IMAGE_GENERATION_MODEL&envDescription=AI%20API%20配置&envLink=https://github.com/6TangYuan/what-to-eat%23环境变量配置)

### Netlify 部署

[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/6TangYuan/what-to-eat)
...
[![Star History Chart](https://api.star-history.com/svg?repos=6TangYuan/what-to-eat&type=Date)](https://www.star-history.com/#6TangYuan/what-to-eat&Date)
